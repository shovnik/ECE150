...
int main(const int argc, const char* const argv[])
{
    ...
    cout << "The equivalent math operation of left-shift N by S bits is: N multiplied by 2 to the "
            "power of S"
         << endl;
    cout << "And the result of that operation is: " << leftShift << endl;
    cout << "The equivalent math operation of right-shift N by S bits is: N divided by 2 to the "
            "power of S rounded towards negative infinity"
         << endl;
