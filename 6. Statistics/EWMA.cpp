...
int main(const int argc, const char* const argv[])
{
    ...
    {
        cerr << "Unable to compute statistics over data set because alpha is not within allowed "
                "range."
             << endl;
    }
    ...
    else
    {
        ...
        const char s = ' '; // separator character for table
        const int w = 10; // width per slot in table
